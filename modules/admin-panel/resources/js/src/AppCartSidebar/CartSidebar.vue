<template>
    <div v-show="cartSidebarIsOpen">
        <div
            ref="bb-side-cart-overlay"
            @click="setCartSidebarIsOpen(false)"
            class="bb-side-cart-overlay hidden w-full h-screen fixed top-[0] left-[0] bg-[#00000080] z-[17]"
        ></div>
        <div
            :class="{
                'bb-side-cart w-[770px] h-[calc(100%-30px)] my-[15px] ml-[15px] pt-[15px] px-[8px] text-[14px] font-normal fixed z-[17] top-[0] right-[0] left-[auto] block transition-all duration-[0.5s] ease delay-[0s] translate-x-[100%] bg-[#fff] overflow-auto opacity-[0] rounded-tl-[20px] rounded-bl-[20px] max-[991px]:w-[740px] max-[767px]:w-[350px] max-[575px]:w-[300px]': true,
                'bb-open-cart': cartSidebarIsOpen,
            }"
        >
            <div class="flex flex-wrap h-full">
                <div
                    class="min-[768px]:w-[41.66%] w-full px-[12px] max-[767px]:hidden"
                >
                    <div class="bb-top-contact">
                        <div
                            class="bb-cart-title w-full mb-[20px] flex flex-wrap justify-between"
                        >
                            <h4
                    ...
                    >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a href="javascript:void(0)">
                                        ...
                                        >
                                            <img
                                                class="main-img transition-all duration-[0.3s] ease delay-[0s] max-w-full"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="ri-heart-line text-[18px] text-[#777] leading-[10px]"
                                                ></i>
                                            </a>
                                        </li>
                                        <li
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="ri-eye-line text-[18px] text-[#777] leading-[10px]"
                                                ></i>
                                            </a>
                                        </li>
                                        <li
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="ri-repeat-line text-[18px] text-[#777] leading-[10px]"
                                                ></i>
                                            </a>
                                        </li>
                                        <li
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="ri-shopping-bag-4-line text-[18px] text-[#777] leading-[10px]"
                                                ></i>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="bb-pro-contact p-[20px]">
                                    ...
                                    >
                                        <a
                                            ...
                                            class="font-Poppins text-[13px] leading-[16px] text-[#777] font-light tracking-[0.03rem]"
                                            >Juice</a
                                        >
                                    ...
                                    <div
                                        class="bb-price flex flex-wrap justify-between"
                                    >
                                        ...
                                        <span
                                            class="last-items text-[14px] text-[#6c7fd8]"
                                            >100 ml</span
                                        >
                                    </div>
                                </div>
                        ...
                        <div class="bb-cart-banner mb-[24px]">
                            <div
                                class="banner rounded-[20px] relative overflow-hidden"
                            >
                                <img
                                ...
                                >
                                    ...
                                    <a
                                        href="shop-left-sidebar-col-3.html"
                                        class="transition-all duration-[0.3s] ease-in-out w-[100px] mt-[15px] py-[5px] px-[10px] border-[1px] border-solid border-[#fff] rounded-[10px] text-[#fff] font-Poppins text-[15px] font-light leading-[28px] tracking-[0.03rem] flex items-center justify-center hover:bg-[#fff] hover:text-[#3d4750]"
                                        >Buy Now</a
                                    >
                                </div>
                            </div>
                ...
                <div class="min-[768px]:w-[58.33%] w-full px-[12px]">
                    <div
                        class="bb-inner-cart relative z-[9] flex flex-col h-full justify-between"
                    >
                        <div class="bb-top-contact">
                            <div
                                class="bb-cart-title w-full mb-[20px] flex flex-wrap justify-between"
                        ...
                        <div
                            class="bb-cart-box item h-full flex flex-col max-[767px]:justify-start"
                        >
                            <ul class="bb-cart-items mb-[-24px]">
                                <p
                                    v-if="!products?.length"
                                    class="bb-wishlist-msg"
                                >
                                    Your Cart is empty!
                                </p>
                                <template v-else>
                                    ...
                                    >
                                        <a
                                            ...
                                            "
                                            href="javascript:void(0)"
                                            class="cart-remove-item transition-all duration-[0.3s] ease-in-out bg-[#3d4750] w-[20px] h-[20px] text-[#fff] absolute top-[-3px] right-[-3px] rounded-[50%] flex items-center justify-center opacity-[0.5] text-[15px]"
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="new-price px-[3px] text-[15px] leading-[18px] text-[#686e7d] font-bold"
                                                    v-text="
                                                        '$' +
                                                        (product.cartable
                                                            .price ?? 0)
                        ...
                        <div class="bb-bottom-cart">
                            ...
                            >
                                <table
                                    class="table cart-table mt-[10px] w-full align-top"
                                >
                                    <tbody>
                                        <tr>
                                            <td
                                                class="title font-medium text-[#777] p-[.5rem]"
                                            >
                                                Sub-Total :
                                            </td>
                                            <td
                                                class="price text-[#777] text-right p-[.5rem]"
                                                v-text="
                                                    '$' +
                            ...
                            <div
                                class="cart-btn flex justify-between mb-[20px]"
                            >
                                <a-component
                                    append="Cart"
                                    :source="blade"
                                    classes="bb-btn-1 transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] py-[5px] px-[15px] text-[14px] font-normal text-[#3d4750] bg-transparent rounded-[10px] border-[1px] border-solid border-[#3d4750] hover:bg-[#6c7fd8] hover:border-[#6c7fd8] hover:text-[#fff]"
                                />
                                <a-component
                                    append="Checkout"
                                    :source="blade"
                                    classes="bb-btn-2 transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] py-[5px] px-[15px] text-[14px] font-normal text-[#fff] bg-[#6c7fd8] rounded-[10px] border-[1px] border-solid border-[#6c7fd8] hover:bg-transparent hover:border-[#3d4750] hover:text-[#3d4750]"
                                />
                            </div>
                        </div>
                    </div>
...
import AComponent from "../AppLogin/AComponent.vue";
...
export default {
    ...
    methods: {
        ...
        attribute(product) {
            let attributeText = "";
            product?.cartable?.attributes.forEach((value, key) => {
                if (
                    this.blade?.attributes.includes(String(value?.attribute.id))
                ) {
                    if (attributeText !== "") {
                        attributeText += ",";
                    }
        ...
        doAdd(id) {
            this.add(id).then(({ data }) => {
                console.log(data);
                if (data !== "undefined") {
                    store.commit("cart/SET_CART", data.data);
                }
            });
            // .catch(({ response: { data } }) => {});
        },
    ...
    watch: {
        cartSidebarIsOpen(newValue) {
            if (newValue) {
                $(this.$refs["bb-side-cart-overlay"]).fadeIn();
            } else {
                $(this.$refs["bb-side-cart-overlay"]).fadeOut();
            }
        },
    },
    mounted() {
        if (this.cartSidebarIsOpen) {
            $(this.$refs["bb-side-cart-overlay"]).fadeIn();
        }
    },
};
